...
namespace TimerMod
{
    public class Timer : MelonMod
    {
            ...
            {   
                ...
                foreach(var sys in f.SystemsAll)
                {
                    ...
                    if (
                        ...
                        || type.Name.Contains("PickupSpawnSystem")
                        || type.Name.Contains("SpecialPickupSpawnSystem")
                    ) {
                        if (enableTimer)
                        {
                            f.SystemDisable(sys);
        ...
        public static void NoRandom(ref Il2CppSystem.Random __instance)
        {
            try
            {
                __instance._inext = 0;
        ...
        private class RandGen
        {
            public static void Prefix(ref Il2CppSystem.Random __instance)
            {
                NoRandom(ref __instance);
                // Log.Msg("RANDOM!!! Gen");
            }
        }

        [HarmonyPatch(typeof(Il2CppSystem.Random), "GenerateGlobalSeed")]
        private class RandGenGlob
        {
            public static void Prefix(Il2CppSystem.Random __instance)
            {
                NoRandom(ref __instance);
                // Log.Msg("RANDOM!!! GenGlob");
            } 
        }

        [HarmonyPatch(typeof(Il2CppSystem.Random), "GetSampleForLargeRange")]
        private class RandGetSampLrgRng
        {
            public static void Prefix(Il2CppSystem.Random __instance)
            {
                NoRandom(ref __instance);
                // Log.Msg("RANDOM!!! GetSampLrgRng");
            } 
        }

        [HarmonyPatch(typeof(Il2CppSystem.Random), "InternalSample")]
        private class RandInternalSample
        {
            public static void Prefix(Il2CppSystem.Random __instance)

            {
                NoRandom(ref __instance);
                // Log.Msg("RANDOM!!! InternalSample");
            } 
        }

        [HarmonyPatch(typeof(Il2CppSystem.Random), "Next", [typeof(int), typeof(int)])]
        private class RandNext1
        {
            public static void Prefix(Il2CppSystem.Random __instance)
            {
                NoRandom(ref __instance);
                // Log.Msg("RANDOM!!! Next1");
            } 
        }

        [HarmonyPatch(typeof(Il2CppSystem.Random), "Next", [typeof(int)])]
        private class RandNext2
        {
            public static void Prefix(Il2CppSystem.Random __instance)
            {
                NoRandom(ref __instance);
                // Log.Msg("RANDOM!!! Next2");
            } 
        }

        [HarmonyPatch(typeof(Il2CppSystem.Random), "Next", [])]
        private class RandNext3
        {
            public static void Prefix(Il2CppSystem.Random __instance)
            {
                NoRandom(ref __instance);
                // Log.Msg("RANDOM!!! Next3");
            } 
        }

        [HarmonyPatch(typeof(Il2CppSystem.Random), "Sample")]
        private class RandSample
        {
            public static void Prefix(Il2CppSystem.Random __instance)
            {
                NoRandom(ref __instance);
                // Log.Msg("RANDOM!!! Sample");
            } 
        }
    }
}
